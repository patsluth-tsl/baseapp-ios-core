...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RxSwiftExt-watchOS/RxSwiftExt.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftDate-watchOS/SwiftDate.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyBeaver-watchOS/SwiftyBeaver.framework"
fi
